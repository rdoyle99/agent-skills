...
description: "Systematic competitive analysis for product positioning, sales enablement, and strategic planning. Use when the user wants to analyze competitors, build battlecards, create comparison pages, understand market positioning, or research competitive landscape. Also triggers on: 'competitor analysis,' 'competitive landscape,' 'battlecard,' 'win/loss analysis,' 'market positioning,' 'how do we compare to,' or 'what is [company] doing.'"
---
